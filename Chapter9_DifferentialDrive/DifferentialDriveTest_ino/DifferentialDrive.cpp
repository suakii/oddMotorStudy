				 				 ...
				 				 int wheelCirc, int wheelDistance)
{
	...
	_yPosition = 0.0;
	_theta = 0.0;	
	_degreesPerMillimeter = 360.0 / (double)wheelCirc;//wheelCirc is 원주 (2*pi*r)
}
									...
									int &leftSpeed, int &rightSpeed)
{
	...
	// suakii
	// linear speed = angular speed * radius of the rotation
	...
	// suakii
	// We want to move robot below speed(degrees/sec)
